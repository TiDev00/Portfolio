...
export const greeting = {
  ...
  subTitle:
    "Fullstack software engineer with 5+ years of experience across Python, Java, C# and TypeScript. I build production software end to end, teach software engineering through practical real-world examples, and bring an AI/NLP research mindset to teams solving meaningful problems",
